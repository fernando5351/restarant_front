  ...
  filterSalesByDate() {
    ...
    this.reportService.getSalesByDate(startDate, endDate).subscribe({
      next: (response) => {
        ...
        this.salesByDateLabel = ["13 Nov 2017", "14 Nov 2017", "15 Nov 2017"]
